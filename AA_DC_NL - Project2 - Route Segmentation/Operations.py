...
class RotateRange(Operation):
    ...
    def __init__(self, probability, max_left_rotation, max_right_rotation):
        ...
        self.max_left_rotation = abs(max_left_rotation)##Modified to always rotate the same
    ...
    def perform_operation(self, image):
        ...
        #random_left = random.randint(0, self.max_left_rotation)
        #random_right = random.randint(0, self.max_right_rotation)

        #left_or_right = random.randint(0, 1)
        #rotation = 0

        rotation = self.max_right_rotation
